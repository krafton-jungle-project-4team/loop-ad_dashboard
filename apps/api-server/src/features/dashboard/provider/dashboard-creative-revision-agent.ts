...
function creativeRevisionPatchInstructions() {
  return [
    ...
    "Placeholders named loopad_offer_price_block_* are immutable server-rendered price blocks that already reflect the requested price tiers.",
    "Preserve those price placeholders byte-for-byte and never add, duplicate, calculate, infer, or display any other monetary offer price.",
