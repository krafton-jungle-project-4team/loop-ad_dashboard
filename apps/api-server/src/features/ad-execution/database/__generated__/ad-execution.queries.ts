 ...
 * ```
 */
export const findPromotionRun = new PreparedQuery<IFindPromotionRunParams, IFindPromotionRunResult>(
  findPromotionRunIR
);
...
const findPromotionIR: any = {
  usedParamSet: { promotionId: true },
  params: [
    {
      name: "promotionId",
      required: false,
...
const findAdExperimentIR: any = {
  usedParamSet: { adExperimentId: true },
  params: [
    {
      name: "adExperimentId",
      required: false,
 ...
 * ```
 */
export const findAdExperiment = new PreparedQuery<IFindAdExperimentParams, IFindAdExperimentResult>(
  findAdExperimentIR
);
...
const listActiveAdServingAssignmentsIR: any = {
  usedParamSet: { promotionRunId: true },
  params: [
    {
      name: "promotionRunId",
...
>(listActiveAdServingAssignmentsIR);
...
const findActiveBannerAssignmentIR: any = {
  ...
  params: [
    ...
    { name: "userId", required: false, transform: { type: "scalar" }, locs: [{ a: 1190, b: 1197 }] }
  ],
  statement:
...
const updateDispatchJobResultIR: any = {
  ...
  params: [
    ...
    { name: "sentCount", required: false, transform: { type: "scalar" }, locs: [{ a: 63, b: 72 }] },
    {
      name: "failedCount",
      required: false,
      transform: { type: "scalar" },
...
const insertRedirectLinkIR: any = {
  ...
  params: [
    ...
    { name: "userId", required: false, transform: { type: "scalar" }, locs: [{ a: 344, b: 350 }] },
    {
      name: "contentId",
      required: false,
      transform: { type: "scalar" },
...
const findRedirectLinkByTokenIR: any = {
