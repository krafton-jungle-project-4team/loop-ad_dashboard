...
const findActiveBannerAssignmentIR: any = {"usedParamSet":{"projectId":true,"promotionRunId":true,"userId":true},"params":[{"name":"projectId","required":false,"transform":{"type":"scalar"},"locs":[{"a":1114,"b":1123}]},{"name":"promotionRunId","required":false,"transform":{"type":"scalar"},"locs":[{"a":1154,"b":1168}]},{"name":"userId","required":false,"transform":{"type":"scalar"},"locs":[{"a":1190,"b":1196}]}],"statement":"SELECT\n  aas.promotion_run_id AS \"promotionRunId\",\n  aas.user_id AS \"userId\",\n  aas.segment_id AS \"segmentId\",\n  aas.ad_experiment_id AS \"adExperimentId\",\n  aas.content_id AS \"contentId\",\n  aas.content_option_id AS \"contentOptionId\",\n  aas.fallback,\n  aas.similarity_score AS \"similarityScore\",\n  aas.project_id AS \"projectId\",\n  aas.campaign_id AS \"campaignId\",\n  aas.promotion_id AS \"promotionId\",\n  aas.channel,\n  aas.subject,\n  aas.preheader,\n  aas.title,\n  aas.body,\n  aas.cta,\n  aas.message,\n  aas.image_prompt AS \"imagePrompt\",\n  p.landing_url AS \"landingUrl\",\n  COALESCE(cc.metadata_json, '{}'::jsonb) AS \"contentMetadataJson\",\n  aas.content_status AS \"contentStatus\",\n  aas.ad_experiment_status AS \"adExperimentStatus\"\nFROM active_ad_serving_assignments aas\nJOIN promotions p\n  ON p.project_id = aas.project_id\n AND p.promotion_id = aas.promotion_id\nLEFT JOIN content_candidates cc\n  ON cc.project_id = aas.project_id\n AND cc.campaign_id = aas.campaign_id\n AND cc.promotion_id = aas.promotion_id\n AND cc.content_id = aas.content_id\n AND cc.content_option_id = aas.content_option_id\nWHERE aas.project_id = :projectId\n  AND aas.promotion_run_id = :promotionRunId\n  AND aas.user_id = :userId\n  AND aas.channel = 'onsite_banner'\nLIMIT 1                                                                                                 "};
...
/** 'FindDispatchJobById' parameters type */
export interface IFindDispatchJobByIdParams {
  dispatchJobId?: string | null | void;
}

/** 'FindDispatchJobById' return type */
export interface IFindDispatchJobByIdResult {
  adExperimentId: string | null;
  channel: string;
...
/** 'FindDispatchJobById' query type */
export interface IFindDispatchJobByIdQuery {
  params: IFindDispatchJobByIdParams;
  result: IFindDispatchJobByIdResult;
}

const findDispatchJobByIdIR: any = {"usedParamSet":{"dispatchJobId":true},"params":[{"name":"dispatchJobId","required":false,"transform":{"type":"scalar"},"locs":[{"a":327,"b":340}]}],"statement":"SELECT\n  ad_dispatch_job_id AS \"dispatchJobId\",\n  promotion_run_id AS \"promotionRunId\",\n  ad_experiment_id AS \"adExperimentId\",\n  channel,\n  status,\n  target_count AS \"targetCount\",\n  sent_count AS \"sentCount\",\n  failed_count AS \"failedCount\",\n  metadata_json AS \"metadataJson\"\nFROM ad_dispatch_jobs\nWHERE ad_dispatch_job_id = :dispatchJobId                                                                  "};
 ...
 * ```
 */
export const findDispatchJobById = new PreparedQuery<IFindDispatchJobByIdParams,IFindDispatchJobByIdResult>(findDispatchJobByIdIR);
...
/** 'RestartFailedDispatchJob' parameters type */
export interface IRestartFailedDispatchJobParams {
  dispatchJobId?: string | null | void;
}

/** 'RestartFailedDispatchJob' return type */
export interface IRestartFailedDispatchJobResult {
  dispatchJobId: string;
}

/** 'RestartFailedDispatchJob' query type */
export interface IRestartFailedDispatchJobQuery {
  params: IRestartFailedDispatchJobParams;
  result: IRestartFailedDispatchJobResult;
}

const restartFailedDispatchJobIR: any = {"usedParamSet":{"dispatchJobId":true},"params":[{"name":"dispatchJobId","required":false,"transform":{"type":"scalar"},"locs":[{"a":159,"b":172}]}],"statement":"UPDATE ad_dispatch_jobs\nSET\n  status = 'running',\n  sent_count = 0,\n  failed_count = 0,\n  started_at = now(),\n  completed_at = NULL\nWHERE ad_dispatch_job_id = :dispatchJobId\n  AND status = 'failed'\nRETURNING\n  ad_dispatch_job_id AS \"dispatchJobId\"                                                                        "};
 ...
 * ```
 */
export const restartFailedDispatchJob = new PreparedQuery<IRestartFailedDispatchJobParams,IRestartFailedDispatchJobResult>(restartFailedDispatchJobIR);
